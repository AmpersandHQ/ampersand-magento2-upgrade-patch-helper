...
|  INFO 	    |   DB schema added	    |   A `db_schema.xml` affecting the highlighted table has been added. <br/><br/> At this `INFO` level no action is needed but it may be useful to know.	|
|  INFO 	    |   DB schema removed	    |  A `db_schema.xml` affecting the highlighted table has been removed. <br/><br/> At this `INFO` level no action is needed but it may be useful to know. 	|
|  INFO 	    |   DB schema changed	    |  A `db_schema.xml` affecting the highlighted table has been changed. <br/><br/> At this `INFO` level no action is needed but it may be useful to know. 	|
